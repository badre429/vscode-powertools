...
export class BmgSortCommand extends BmgCommand {
    constructor(private context: vscode.ExtensionContext) {
        ...
        this.paramsLoader.push({
            ...
            command: this,
            value: null,
            load: this.LoadFunctionOfSelect("direction", ["Asc Case Insensitive","Asc", "Dec",  "Line Length", "Unique", "Shuffle"])
        });
    ...
    sortActiveSelection(algorithm, removeDuplicateValues) {
        ...
        this.sortLines(textEditor, selection.start.line, selection.end.line, algorithm, removeDuplicateValues);
    }
